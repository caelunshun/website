		...
		>
			...
			<div class="flex flex-col mt-4">
				...
				<ul class="flex flex-wrap">
					{#each plugin.owners as owner}
						<li>
							<a href="/users/{owner}" class="mr-2 border-b-2 border-feather-accent">{owner}</a>
						</li>
					{/each}
				</ul>
			</div>
			...
			<div class="flex flex-col mt-4">
				...
				<ul class="flex flex-wrap">
					{#each plugin.keywords as keyword}
						<li>
							<a href="/plugins" class="mr-2 border-b-2 border-feather-accent">{keyword}</a>
						</li>
					{/each}
				</ul>
			</div>
			<div class="flex flex-col mt-4">
				...
				<ul class="flex flex-wrap">
					{#each plugin.categories as category}
						<li>
							<a href="/plugins" class="mr-2 border-b-2 border-feather-accent">{category}</a>
						</li>
					{/each}
				</ul>
			</div>
			<div class="flex flex-col mt-4">
				...
				<ul class="flex flex-wrap">
					{#each plugin.versions as version}
						<li>
							<a href="/plugins" class="mr-2 border-b-2 border-feather-accent">{version}</a>
						</li>
					{/each}
				</ul>
			</div>
			<div class="flex mt-8">
				<div class="flex items-center">
					<abbr title="Total downloads of this plugin"><DownloadCloudIcon class="h-8 w-8" /></abbr
