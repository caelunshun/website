...
<div class="container mx-auto py-8">
    ...
    >
        ...
        >
            ...
            <p>
                To run Feather on a native Windows system first download its binaries from the
                latest
                <a
                    href="https://github.com/feather-rs/feather/releases/latest"
                    target="_blank"
        ...
        >
            ...
            <p>
                ...
                available:
                <a
                    href="https://hub.docker.com/r/buddyspencer/feather"
                    target="_blank"
                    rel="noopener">buddyspencer/feather</a
                >
            </p>
        </OSTab>
    </div>
