...
<div class="container mx-auto">
	...
	<div
		...
		role="tablist"
		aria-label="Installation instructions Tabs"
	>
		<OSTab
		...
		>
			...
			{@html nixcmd}
			<p>
				or download the latest <a
					href="https://github.com/feather-rs/feather/releases/latest"
					target="_blank"
		...
		>
			...
			<button
				...
				on:click={() =>
					window.open(
						'https://github.com/feather-rs/feather/releases/latest/download/feather-v0.6.0-windows.zip'
					)}
			>
				Download
			</button>
			<p>
				To run Feather on a native Windows system first download its binaries from the latest
				<a
					href="https://github.com/feather-rs/feather/releases/latest"
					target="_blank"
					rel="noopener">GitHub release</a
			...
			<p>
				...
				<a
					href="https://docs.microsoft.com/en-gb/windows/wsl/install-win10"
					target="_blank"
					rel="noopener">Windows Subsystem for Linux</a
				>
		...
		>
			...
			<ul>
				<li>
					<a href="https://rustup.rs/" target="_blank" rel="noopener">Rust</a> (latest toolchain version)
				</li>
			</ul>
			...
			<ol>
				<li>
					Clone Feathers source code from <a
			...
			<blockquote>
				<p>
					<strong>Note:</strong> Building via cargo can generate a decent amount of debug files. If
					you want to generate the minimalist binary remove <code>debug = true</code> from
		...
		>
			<h4>Container</h4>
			<p>
				If you want to use Feather via Docker there currently is the following Container available:
				<a href="https://hub.docker.com/r/buddyspencer/feather" target="_blank" rel="noopener"
					>buddyspencer/feather</a
				>
			</p>
		</OSTab>
	</div>
