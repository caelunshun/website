...
<div class="container mx-auto">
    ...
    <div class="md:relative md:flex flex-grow md:border-b border-gray-500 text-gray-500 dark:text-gray-50 w-full">
        <OSTab curSelIndex={selectedTabIndex} desSelIndex={0} name="Linux" setSelIndex={setTabIndex} OSIcon={LinuxIcon} setSpacer={setSpacerHeight}>
            ...
            {@html nixcmd}
            <p>or download the latest <a href="https://github.com/feather-rs/feather/releases/latest" target="_blank" rel="noopener" tabindex={3}>GitHub release</a> and unzip it.</p>
            <h5>Alternative</h5>
            <p>Alternatively you can also build Feather <span class="sanchor text-gray-900 dark:text-gray-200" tabindex={3} on:click={() => {setTabIndex(3)}}>from source</span>. 
        ...
        <OSTab curSelIndex={selectedTabIndex} desSelIndex={2} name="Windows" setSelIndex={setTabIndex} OSIcon={WindowsIcon} setSpacer={setSpacerHeight}>
            ...
            <p>To run Feather on a native Windows system first download its binaries from the latest 
                <a href="https://github.com/feather-rs/feather/releases/latest" target="_blank" rel="noopener" tabindex={3}>GitHub release</a>.</p>
            <p>Alternative: Clone and build <span class="sanchor text-gray-900 dark:text-gray-200" tabindex={3} on:click={() => {setTabIndex(3)}}>from source</span>. 
                This will guarantee that you have the latest version of Feather.</p>
            <h5>Running</h5>
            <p>Second execute the <code>feather-server.exe</code> executable via a Terminal.</p>
            <h4>Subsystem</h4>
            <p>If you want to run Feather from a 
                <a href="https://docs.microsoft.com/en-gb/windows/wsl/install-win10" target="_blank" rel="noopener" tabindex={3}>Windows Subsystem for Linux</a> 
                look at the download instructions for 
                <span class="sanchor text-gray-900 dark:text-gray-200" tabindex={3} on:click={() => {setTabIndex(0)}}>Linux</span> 
        ...
        <OSTab curSelIndex={selectedTabIndex} desSelIndex={3} name="From source" setSelIndex={setTabIndex} OSIcon={PackageIcon} fill={false} setSpacer={setSpacerHeight}>
            ...
            <ul>
                <li><a href="https://rustup.rs/" target="_blank" rel="noopener" tabindex={3}>Rust</a> (latest toolchain version)</li>
            </ul>
            <h4>Cloning and Installing</h4>
            <p>To clone and install Feather from source do the following:</p>
            <ol>
                <li>Clone Feathers source code from <a href="https://github.com/feather-rs/feather" target="_blank" rel="noopener" tabindex={3}>here</a></li>
        ...
        <OSTab curSelIndex={selectedTabIndex} desSelIndex={4} name="Docker" setSelIndex={setTabIndex} OSIcon={DockerIcon} setSpacer={setSpacerHeight}>
            ...
            <p>If you want to use Feather via Docker there currently is the following Container available: 
                <a href="https://hub.docker.com/r/buddyspencer/feather" target="_blank" rel="noopener" tabindex={3}>buddyspencer/feather</a></p>
        </OSTab>
    </div>
